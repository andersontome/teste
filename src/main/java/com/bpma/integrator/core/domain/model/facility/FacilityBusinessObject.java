...
//	private Long idFacilityBusinessObject;
	...
	@Id
	@EqualsAndHashCode.Include
	@SequenceGenerator(name = "seqfacilitybusinessobject", sequenceName = "seqfacilitybusinessobject", allocationSize = 1, initialValue = 9684) 
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqfacilitybusinessobject")
	private Long idFacilityBusinessObject;
